        ...
        <div className='w-full h-screen'>
            ...
            <div className='top-0  absolute w-full h-full flex flex-col justify-center text-white'>
                <div className='md:left-[10%] max-w-[1100px] m-auto absolute p-4'>
                    ...
                    <p className='max-w-[600px] drop-shadow-2xl py-2 text-xl'> Lorem ipsum dolor, sit amet consectetur adipisicing elit. Incidunt iste aut vero vitae? Dolorum excepturi dolor, natus nisi consectetur commodi.</p>
